...
!***********************************************************************************************************************************
    ...
    subroutine generateSyntheticSample(ParaPost, SynRed, outFilePath, sampleCount)
        ...
        integer(IK) , intent(in)                    :: sampleCount
        ...
        real(RK), allocatable   :: GrbInt(:), GrbObs(:)
        integer(IK)             :: isample, iParaPost, iRedshift, fileUnit, itick
