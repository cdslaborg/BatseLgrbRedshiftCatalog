...
set LGRB_RATE_MODEL=H06

:: set Kfactor correction: OneThird, None
set KFAC_CORRECTION=OneThird

:: set the normalization computation condition in ParaPost_mod
set PARAPOSTNORM_DISABLED=true
...
set         SYNSAM_OBJ_BUILD_ENABLED=true
set         SYNSAM_EXE_BUILD_ENABLED=true
set               SYNSAM_RUN_ENABLED=true
...
set INTEL_FORTRAN_DEBUG_FLAGS=/debug:full /Zi /CB /Od /Qinit:snan,arrays /warn:all /gen-interfaces /traceback /check:all /check:bounds /fpe-all:0 /Qdiag-error-limit:10 /Qdiag-disable:5268 /Qdiag-disable:7025 /Qtrapuv
...
set INTEL_FORTRAN_RELEASE_FLAGS=/O3 /Qip /Qipo /Qunroll /Qunroll-aggressive
...
set INTEL_FORTRAN_TESTING_FLAGS=/Od
...
set INTEL_CPP_DEBUG_FLAGS=/debug:full /Zi /Od /Wall /traceback /Qcheck-pointers:rw /Qcheck-pointers-undimensioned /Qdiag-error-limit:10 /Qtrapuv
...
set INTEL_CPP_RELEASE_FLAGS=/O3 /Qip /Qipo /Qunroll /Qunroll-aggressive /Ob2 /Qparallel /Qinline-dllimport
...
set INTEL_CPP_TESTING_FLAGS=/Od
