...
for igrb = 1:ngrb
    LaTab{igrb} =   [ num2str(Zmodel.(Zmodel.ID{1}).data(igrb,1)) ...
                    ...
                    , ' & $[' ...
                    , sprintf('%.2f',round(Zmodel.(Zmodel.ID{1}).data(igrb,5),2)) ...
                    , ' , ' ...
                    , sprintf('%.2f',round(Zmodel.(Zmodel.ID{1}).data(igrb,7),2)) ...
                    , ']$ & $[' ...
                    ...
                    , ' & $[' ...
                    , sprintf('%.2f',round(Zmodel.(Zmodel.ID{2}).data(igrb,5),2)) ...
                    , ' , ' ...
                    , sprintf('%.2f',round(Zmodel.(Zmodel.ID{2}).data(igrb,7),2)) ...
                    , ']$ & $[' ...
                    ...
                    , ' & $[' ...
                    , sprintf('%.2f',round(Zmodel.(Zmodel.ID{3}).data(igrb,5),2)) ...
                    , ' , ' ...
                    , sprintf('%.2f',round(Zmodel.(Zmodel.ID{3}).data(igrb,7),2)) ...
                    , ']$ & $[' ...
