...
% read Yonetoku data
Rival = importdata('../../in/RedshiftYonetoku2004.txt');
...
icolRival = 5; % the column number of Yonetoku 2004 redshift predictions
...
for imodel = 1:nModelSFR
    ...
    ylabel('Predicted Redshift: Yonetoku (2004)', 'fontSize', fontSize)
    xlim(RangeZ);
    ylim(RangeZ);
    set(gca,'xscale','log')
    set(gca,'yscale','log')
