...
set                   SyntheticRedshift_PNAME=SyntheticRedshift
set               SyntheticRedshift_RATE_TYPE=StarFormationRate
::set               SyntheticRedshift_RATE_TYPE=StarFormationRateDensity
set             SyntheticRedshift_OBJ_ENABLED=TRUE
set             SyntheticRedshift_EXE_ENABLED=TRUE
set             SyntheticRedshift_RUN_ENABLED=TRUE
...
if not defined            ParaMonteTest_OBJ_ENABLED set            ParaMonteTest_OBJ_ENABLED=FALSE
if not defined            ParaMonteTest_EXE_ENABLED set            ParaMonteTest_EXE_ENABLED=FALSE
if not defined            ParaMonteTest_RUN_ENABLED set            ParaMonteTest_RUN_ENABLED=FALSE
if not defined ParaMonteExampleGaussian_OBJ_ENABLED set ParaMonteExampleGaussian_OBJ_ENABLED=FALSE
if not defined ParaMonteExampleGaussian_EXE_ENABLED set ParaMonteExampleGaussian_EXE_ENABLED=FALSE
if not defined ParaMonteExampleGaussian_RUN_ENABLED set ParaMonteExampleGaussian_RUN_ENABLED=FALSE
if not defined                ParaMonte_DLL_ENABLED set                ParaMonte_DLL_ENABLED=FALSE
...
if not defined                              BTYPE set                             BTYPE=testing
...
if not defined                   COMPILER_VERSION set                  COMPILER_VERSION=18.0.2.185
if not defined                   COMPILER_VERSION set                  COMPILER_VERSION=19.0.2.190
